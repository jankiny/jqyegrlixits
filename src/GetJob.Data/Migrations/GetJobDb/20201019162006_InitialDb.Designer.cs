...
namespace GetJob.Data.Migrations.GetJobDb
{
    ...
    [Migration("20201019162006_InitialDb")]
            ...
            modelBuilder.Entity("GetJob.Models.Deliver", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "3eed3eed-3eed-2020-3eed-123456789abc",
                            DeliverDateTime = new DateTime(2020, 10, 20, 0, 20, 5, 985, DateTimeKind.Local).AddTicks(6509),
                            DeliverStatusId = 1,
            ...
            modelBuilder.Entity("GetJob.Models.InterviewNotify", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            InterviewDate = new DateTime(2020, 10, 20, 0, 20, 5, 985, DateTimeKind.Local).AddTicks(9126),
                            InterviewLocation = "",
                            Note = "",
                            Title = "通知测试种子数据"
                        });
            ...
            modelBuilder.Entity("GetJob.Models.Job", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            JobPayId = 4,
                            JobStatusId = 1,
                            LastModify = new DateTime(2020, 10, 20, 0, 20, 5, 982, DateTimeKind.Local).AddTicks(2074),
                            LocationId = 330105,
                            Name = "测试攻城师",
                            RecruitNumber = 19
                        });
            ...
            modelBuilder.Entity("GetJob.Models.JobCollection", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "3eed3eed-3eed-2020-3eed-123456789abc",
                            CollectionDateTime = new DateTime(2020, 10, 20, 0, 20, 5, 986, DateTimeKind.Local).AddTicks(2511),
                            JobId = "3eed3eed-3eed-2020-3eed-123456789abc",
            ...
            modelBuilder.Entity("GetJob.Models.Resume", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "3eed3eed-3eed-2020-3eed-123456789abc",
                            Certificate = "",
                            CreateDateTime = new DateTime(2020, 10, 20, 0, 20, 5, 984, DateTimeKind.Local).AddTicks(2564),
            ...
            modelBuilder.Entity("GetJob.Models.ResumeSubmitted", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "3eed3eed-3eed-2020-3eed-123456789abc",
                            Certificate = "",
                            CreateDateTime = new DateTime(2020, 10, 20, 0, 20, 5, 984, DateTimeKind.Local).AddTicks(8603),
                            ForJobAddressId = 330105,
                            ForJobCharacterId = 1,
                            ForJobKindId = 10001,
                            ForJobPayId = 1,
            ...
            modelBuilder.Entity("GetJob.Models.Student", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Address = "null",
                            BirthPlaceId = 330106,
                            Birthday = new DateTime(2020, 10, 20, 0, 20, 5, 983, DateTimeKind.Local).AddTicks(6641),
                            College = "浙江树人大学",
                            DegreeId = 2,
            ...
            modelBuilder.Entity("GetJob.Models.StudentCollection", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "3eed3eed-3eed-2020-3eed-123456789abc",
                            CollectionDateTime = new DateTime(2020, 10, 20, 0, 20, 5, 986, DateTimeKind.Local).AddTicks(5023),
                            CompanyId = "3eed3eed-3eed-2020-3eed-123456789abc",
                            StudentId = "3eed3eed-3eed-2020-3eed-123456789abc"
                        });
                });
