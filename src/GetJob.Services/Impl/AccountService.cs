...
namespace GetJob.Services.Impl
{
    public class AccountService : IAccountService
    {
        ...
        public AccountService( ILogger<AccountService> logger, RoleManager<IdentityRole> roleManager, UserManager<Student> userManager, SignInManager<Student> signInManager)
        {
            _logger = logger;
        ...
        public async Task<IdentityResult> CreateUserAsync(Student user, string plainPassword)
        {
            try
            {
